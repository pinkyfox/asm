...
start:
    ...
    mov bx, stack_shift shr 4 + 1               ;длину программы в байтах сдвигаем на 4 бита вправо (shr), что эквивалентно делению на 16
                                                ;+ 1, таким образом получаем размер с нашей программы в параграфах (на один параграф больше)
